...
public sealed partial class ConfGuides :  Bright.Config.BeanBase 
{
    public ConfGuides(ByteBuf _buf) 
    {
        ...
        {int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);OnMaskObjs = new System.Collections.Generic.List<string>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { string _e0;  _e0 = _buf.ReadString(); OnMaskObjs.Add(_e0);}}
    ...
    /// 临时位于遮罩上的物体
    /// </summary>
    public System.Collections.Generic.List<string> OnMaskObjs { get; protected set; }
    /// <summary>
    /// 开始引导时的额外字段
    /// </summary>
    ...
    public void Reload(ConfGuides reloadData)
    {
        ...
        if(OnMaskObjs==null)
        {
            OnMaskObjs = reloadData.OnMaskObjs;
        }else
        {
            OnMaskObjs.Capacity = reloadData.OnMaskObjs.Count;
            for (int i = 0; i < reloadData.OnMaskObjs.Count; i++)
            {
                OnMaskObjs[i] = reloadData.OnMaskObjs[i];
            }
        }
        if(ExtraStart==null)
        {
    ...
    public override string ToString()
    {
        ...
        + "OnMaskObjs:" + Bright.Common.StringUtil.CollectionToString(OnMaskObjs) + ","
