...
namespace XrCode
{
    public class AudioModule : BaseModule
    {
        ...
        private SAndroidNativeHelper SANH;                                //震动组件（请确保AndroidPlugins/SAndroidNativeHelper的存在）
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
            SANH = new SAndroidNativeHelper();
            SANH.CreatedInstance();
#endif
