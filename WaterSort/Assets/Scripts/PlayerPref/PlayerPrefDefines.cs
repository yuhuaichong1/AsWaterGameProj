...
public abstract class PlayerPrefDefines
{
    ...
    public static string withdrawalCoin => GetKey("■_withdrawalCoin");          //WithdrawModule_玩家累计兑现金额
    public static string wName => GetKey("■_wName");                            //WithdrawModule_兑现姓名
    public static string wPhoneOrEmail => GetKey("■_wPhoneOrEmail");            //WithdrawModule_兑现信息
    public static string poeType => GetKey("■_poeType");                        //WithdrawModule_兑现信息类型
    public static string isEarning => GetKey("■_isEarning");                    //WithdrawModule_是否处于争取指定金额兑现过程中
    public static string wrisTemp => GetKey("■_wrisTemp");                      //WithdrawModule_兑现记录
    public static string curWithdrawTarget => GetKey("■_curWithdrawTarget");    //WithdrawModule_当前兑现目标
