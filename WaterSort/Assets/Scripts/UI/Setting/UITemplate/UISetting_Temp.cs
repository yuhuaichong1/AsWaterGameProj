...
namespace XrCode
{
    public partial class UISetting : BaseUI
    {
        ...
        protected override void LoadPanel()
        {
            ...
            mWRButton = mTransform.Find("Plane/WRButton").GetComponent<RectTransform>();
            ...
            mBtnUserAgreement = mTransform.Find("Plane/UserAgreement/BtnUserAgreement").GetComponent<Button>();
            mBtnPrivacyPolicy = mTransform.Find("Plane/PrivacyPolicy/BtnPrivacyPolicy").GetComponent<Button>();
        }
        ...
        protected override void BindButtonEvent()
        {
            ...
            mBtnUserAgreement.onClick.AddListener(OnBtnUserAgreementClickHandle);
            mBtnPrivacyPolicy.onClick.AddListener(OnBtnPrivacyPolicyClickHandle);
        ...
        protected override void UnBindButtonEvent()
        {
            ...
            mBtnUserAgreement.onClick.RemoveAllListeners();
            mBtnPrivacyPolicy.onClick.RemoveAllListeners();
            mS_Toggle.onValueChanged.RemoveListener(OnS_ToggleValueChange);
            mV_Toggle.onValueChanged.RemoveListener(OnV_ToggleValueChange);
        }
