...
namespace XrCode
{
	...
	protected RectTransform mPockets;
	protected RectTransform mCupPartShadow;
	protected RectTransform mCupPart;
	protected RectTransform mShuffleTip;
	protected Button mTipExitBtn;
	protected RectTransform mShuffleTip2;
		...
		mPockets = mTransform.Find("Plane/Center/PocketPart/Pockets").GetComponent<RectTransform>();
		mCupPartShadow = mTransform.Find("Plane/Center/CupPartShadow").GetComponent<RectTransform>();
		mCupPart = mTransform.Find("Plane/Center/CupPart").GetComponent<RectTransform>();
		mShuffleTip = mTransform.Find("Tips/ShuffleTip").GetComponent<RectTransform>();
		mTipExitBtn = mTransform.Find("Tips/ShuffleTip/TipExitBtn").GetComponent<Button>();
		mShuffleTip2 = mTransform.Find("Tips/ShuffleTip2").GetComponent<RectTransform>();
        }
		...
		mTipExitBtn.onClick.AddListener( OnTipExitBtnClickHandle);
        }
		...
		mTipExitBtn.onClick.RemoveAllListeners();
        }
