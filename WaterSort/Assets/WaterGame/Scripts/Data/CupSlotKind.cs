    ...
    public static class CupSlotKindUtility
    {
        ...
        public static void SetKind(CupData cup, CupSlotKind kind)
        {
            ...
            switch (kind)
            {
                case CupSlotKind.空槽:
                    cup.isNull = 1;
                    cup.colors ??= new System.Collections.Generic.List<int>();
                    cup.colors.Clear();
                    cup.whNums = 0;
                    break;
                ...
                case CupSlotKind.空瓶:
                    ...
                    cup.whNums = 0;
                    break;
                case CupSlotKind.普通瓶:
                    break;
            }
        }

        public static string GetKindShortTag(CupData cup)
        {
            return GetKind(cup) switch
            {
                CupSlotKind.空槽 => "空槽",
                CupSlotKind.广告瓶 => "广告",
                CupSlotKind.锁瓶 => "锁",
